...
# --- Konfiguracja ---
DRIVE_FILE_NAME = "pamietnik_ai_data.txt" 
...
def get_drive_service():
    try:
        ...
        st.error("Upewnij się, że wszystkie pola w [gcp_service_account] w 'Secrets' są poprawnie wklejone.")
        return None
...
try:
    ...
    st.error(f"Błąd konfiguracji Gemini API: {e}. Sprawdź swój klucz.")
    st.stop()
